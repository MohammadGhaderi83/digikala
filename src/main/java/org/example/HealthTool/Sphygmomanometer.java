...
public class Sphygmomanometer extends HealthTool{
    ...
    public Sphygmomanometer(String name, String brand, double price, int number, String color, String ID, String companyName, String supplyPower, String used, String suitableArmSize, String displayType) {
