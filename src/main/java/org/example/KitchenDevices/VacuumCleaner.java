...
public class VacuumCleaner extends KitchenDevices{
    ...
    public VacuumCleaner(String name, String brand, double price, int number, String color, double volume, String energyConsumptionChart, int enginePower, int powerCableLength) {
