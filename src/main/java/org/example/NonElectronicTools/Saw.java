...
public class Saw extends NonElectronicTools{
    ...
    public Saw(String name, String brand, double price, int number, String color, String ID, String companyName, String material, int weight, int ironBladeLength, String used) {
